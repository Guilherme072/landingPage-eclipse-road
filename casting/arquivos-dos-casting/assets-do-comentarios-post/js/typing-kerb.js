...
for (var i = 0; i < elements.length; i++) {
    var toRotate = ["caçador de comentários hilários", "curador dos melhores replies", "um perfil que valoriza a criatividade alheia", "fã de humor espontâneo da internet"]
    var period = 3000;
    if (toRotate) {
