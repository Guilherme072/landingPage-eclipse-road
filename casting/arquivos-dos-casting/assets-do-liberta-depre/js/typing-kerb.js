...
for (var i = 0; i < elements.length; i++) {
    var toRotate = ["o mais apaixonado pela Libertadores", "especialista em drama sul-americano", "contador de causos da competição", "fã de noites históricas e zebras"]
    var period = 3000;
    if (toRotate) {
