...
new Chart(ctx1, {
    ...
    data: {
        ...
        datasets: [{
            data: [1.8, 68.4, 27.3, 2.5], // Pico absoluto em 18-24 anos (noitadas + humor adulto)
...
new Chart(ctx2, {
    ...
    data: {
        ...
        datasets: [{
            data: [94.2, 4.7, 1.1], // Perfil quase exclusivamente masculino
...
new Chart(ctx3, {
    ...
    data: {
        ...
        datasets: [{
            data: [3.1, 72.8, 21.5, 2.4, 0.2], // Instagram ainda mais concentrado em 18-24
...
new Chart(ctx4, {
    ...
    data: {
        ...
        datasets: [{
            data: [96.1, 3.9], // Instagram com participação feminina quase inexistente
